...
function Game() {
    ...
    var pd = {
        ...
        'clickers':{
            ...
            'underwater_lab': {
                'label':'Underwater Laboratory',
                'description':'A deep sea laboratory for high pressure cooking',
                'amount':0,
                'risk':0.005,
                'rps':6000,
                'base_cost':16000000,
            ...
            'methlantis': {
                'label':'Methlantis',
                'description':'Reclaim some sunken ruins and establish an offshore kitchen',
                'amount':0,
                'risk':0.01,
                'rps':75000,
